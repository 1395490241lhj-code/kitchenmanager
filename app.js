// v118 app.js - 优化常备品分类(增加香料/调整味精) + 修复 <think> 解析 + 保持用户配置
// 1. 全局错误捕获
...
function renderShopping(pack){
  ...
  const categories = [
    ...
    { name: "基础调味", items: ["盐", "糖", "醋", "生抽", "老抽", "料酒", "蚝油", "香油", "味精", "鸡精"] },
    { name: "香料/干货", items: ["淀粉", "豆瓣酱", "花椒", "干辣椒", "胡椒粉", "八角", "桂皮", "香叶", "五香粉"] },
