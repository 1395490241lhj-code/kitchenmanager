...
const CUSTOM_AI = {
  ...
  MODEL: "qwen/qwen3-32b" // 注意：若 Groq 暂不支持此模型，请改回 llama3-70b-8192
};
...
// -------- AI Services (Integrated Config) --------
function getAiConfig() {
  // 优先使用代码中的配置，如果没有填 Key，再尝试从 localStorage 读取
