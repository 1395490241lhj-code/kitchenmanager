...
const CACHE = 'kitchen-cache-v7';
const ASSETS = ['./','./index.html','./index.html?v=7','./data/sichuan-recipes.json','./data/sichuan-recipes.json?v=7','./sichuan-loader.js','./sichuan-loader.js?v=7'];
