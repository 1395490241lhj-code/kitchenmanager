...
const CACHE = 'kitchen-cache-v6';
const ASSETS = [
  './','./index.html','./index.html?v=6',
  './styles.css','./styles.css?v=6',
  './app.js','./app.js?v=6',
  './app.patch.v6.js','./app.patch.v6.js?v=6',
  './sichuan-loader.js','./sichuan-loader.js?v=6',
  './manifest.webmanifest','./manifest.webmanifest?v=6'
];
