...
function enhanceReceiptCanvas(ctx, width, height, mode = 'standard') {
  ...
  const contrast = strong ? 1.22 : 1.12;
  const brightness = strong ? 8 : 4;
  const grayscaleMix = strong ? 0.28 : 0.12;
  const sharpenAmount = strong ? 0.18 : 0.08;
  let imageData;
  try {
