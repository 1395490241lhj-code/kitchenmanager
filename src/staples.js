...
import { S } from './storage.js?v=165';
import { getCanonicalName } from './ingredients.js?v=165';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from './shopping.js?v=165';
