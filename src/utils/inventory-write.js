...
import { buildCatalog, getCanonicalName, getDryPrepText, guessKitchenUnit, guessShelfDays, isDryGoodName } from '../ingredients.js?v=238';
import { loadInventory, mergeInventoryEntry } from '../inventory.js?v=238';
import { applyReceiptPantryItems } from './receipt-import.js?v=238';
