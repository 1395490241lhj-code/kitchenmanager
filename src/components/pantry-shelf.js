 ...
 */
import { DRY_GOODS, EGG_STOCK, DAILY_STOCKS, guessShelfDays } from '../ingredients.js?v=171';
import { ensureStockItem, findStockItem, saveInventory } from '../inventory.js?v=171';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from '../shopping.js?v=171';
