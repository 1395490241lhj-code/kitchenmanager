 ...
 */
import { DRY_GOODS, EGG_STOCK, DAILY_STOCKS, guessShelfDays } from '../ingredients.js?v=217';
import { ensureStockItem, findStockItem, saveInventory, syncOutOfStockTimestamp } from '../inventory.js?v=217';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from '../shopping.js?v=217';
import { applyPantryCustomConfig } from '../staples.js?v=217';
