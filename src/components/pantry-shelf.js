 ...
 */
import { DRY_GOODS, EGG_STOCK, DAILY_STOCKS, guessShelfDays } from '../ingredients.js?v=202';
import { ensureStockItem, findStockItem, saveInventory } from '../inventory.js?v=202';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from '../shopping.js?v=202';
import { applyPantryCustomConfig } from '../staples.js?v=202';
import { escapeHtml } from './status.js?v=202';
