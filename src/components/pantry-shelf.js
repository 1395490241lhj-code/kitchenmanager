 ...
 */
import { DRY_GOODS, EGG_STOCK, DAILY_STOCKS, guessShelfDays } from '../ingredients.js?v=177';
import { ensureStockItem, findStockItem, saveInventory } from '../inventory.js?v=177';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from '../shopping.js?v=177';
import { escapeHtml } from './status.js?v=177';
