 ...
 */
import { DRY_GOODS, EGG_STOCK, DAILY_STOCKS, guessShelfDays } from '../ingredients.js?v=182';
import { ensureStockItem, findStockItem, saveInventory } from '../inventory.js?v=182';
import { addShoppingItem, loadShoppingItems, saveShoppingItems } from '../shopping.js?v=182';
import { escapeHtml } from './status.js?v=182';
