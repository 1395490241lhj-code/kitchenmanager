...
import {
  ...
  toggleStaple,
  updatePantryEntry
} from '../staples.js?v=211';
import { renderDryGoodsCabinet } from './pantry-shelf.js?v=211';
import { guessKitchenUnit } from '../ingredients.js?v=211';
import { escapeHtml, escapeOptionAttr, setInlineStatus } from './status.js?v=211';
