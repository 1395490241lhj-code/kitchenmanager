...
import {
  ...
  toggleStaple,
  updatePantryEntry
} from '../staples.js?v=235';
import { renderDryGoodsCabinet } from './pantry-shelf.js?v=235';
import { guessKitchenUnit } from '../ingredients.js?v=235';
import { escapeHtml, escapeOptionAttr, setInlineStatus } from './status.js?v=235';
