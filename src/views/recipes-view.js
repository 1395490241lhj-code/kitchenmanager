import { loadOverlay, saveOverlay } from '../backup.js?v=181';
import { genId } from '../shopping.js?v=181';
import { hasRecipeMethod } from '../recommendations.js?v=181';
import { recipeCard, renderRecipeSearchResults } from '../components/recipe-card.js?v=181';
import { buildCatalog } from '../ingredients.js?v=181';
import { loadInventory } from '../inventory.js?v=181';
import { importRecipeFromSource, formatAiErrorMessage } from '../ai.js?v=181';
import { escapeHtml, setInlineStatus } from '../components/status.js?v=181';
