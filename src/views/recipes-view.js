import { loadOverlay, saveOverlay } from '../backup.js?v=198';
import { genId } from '../shopping.js?v=198';
import { hasRecipeMethod } from '../recommendations.js?v=198';
import { recipeCard, renderRecipeSearchResults } from '../components/recipe-card.js?v=198';
import { buildCatalog } from '../ingredients.js?v=198';
import { loadInventory } from '../inventory.js?v=198';
import { importRecipeFromSource, formatAiErrorMessage } from '../ai.js?v=198';
import { escapeHtml, setInlineStatus } from '../components/status.js?v=198';
