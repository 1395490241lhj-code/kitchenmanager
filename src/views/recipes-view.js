import { loadOverlay, saveOverlay } from '../backup.js?v=196';
import { genId } from '../shopping.js?v=196';
import { hasRecipeMethod } from '../recommendations.js?v=196';
import { recipeCard, renderRecipeSearchResults } from '../components/recipe-card.js?v=196';
import { buildCatalog } from '../ingredients.js?v=196';
import { loadInventory } from '../inventory.js?v=196';
import { importRecipeFromSource, formatAiErrorMessage } from '../ai.js?v=196';
import { escapeHtml, setInlineStatus } from '../components/status.js?v=196';
