import { loadOverlay, saveOverlay } from '../backup.js?v=182';
import { genId } from '../shopping.js?v=182';
import { hasRecipeMethod } from '../recommendations.js?v=182';
import { recipeCard, renderRecipeSearchResults } from '../components/recipe-card.js?v=182';
import { buildCatalog } from '../ingredients.js?v=182';
import { loadInventory } from '../inventory.js?v=182';
import { importRecipeFromSource, formatAiErrorMessage } from '../ai.js?v=182';
import { escapeHtml, setInlineStatus } from '../components/status.js?v=182';
