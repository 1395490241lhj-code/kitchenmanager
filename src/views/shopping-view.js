...
import {
  ...
  toggleStaple
} from '../staples.js?v=179';
import { renderInventory } from './inventory-view.js?v=179';
import { renderDryGoodsCabinet } from '../components/pantry-shelf.js?v=179';
import { getPlanRange } from '../components/menu-plan.js?v=179';
