...
import {
  ...
  toggleStaple
} from '../staples.js?v=177';
import { renderInventory } from './inventory-view.js?v=177';
import { renderDryGoodsCabinet } from '../components/pantry-shelf.js?v=177';
import { getPlanRange } from '../components/menu-plan.js?v=177';
