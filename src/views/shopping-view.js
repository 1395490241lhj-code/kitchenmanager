...
import {
  ...
  toggleStaple
} from '../staples.js?v=184';
import { renderInventory } from './inventory-view.js?v=184';
import { renderDryGoodsCabinet } from '../components/pantry-shelf.js?v=184';
import { getPlanRange } from '../components/menu-plan.js?v=184';
