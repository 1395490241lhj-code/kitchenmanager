...
import {
  ...
  toggleStaple
} from '../staples.js?v=197';
import { renderInventory } from './inventory-view.js?v=197';
import { renderDryGoodsCabinet } from '../components/pantry-shelf.js?v=197';
