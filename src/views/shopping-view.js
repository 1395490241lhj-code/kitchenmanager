...
import {
  ...
  toggleStaple
} from '../staples.js?v=178';
import { renderInventory } from './inventory-view.js?v=178';
import { renderDryGoodsCabinet } from '../components/pantry-shelf.js?v=178';
import { getPlanRange } from '../components/menu-plan.js?v=178';
