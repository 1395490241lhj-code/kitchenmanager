...
import { loadShoppingItems } from '../../shopping.js?v=236';
import { escapeHtml, showToast } from '../../components/status.js?v=236';
import { buildKitchenBackup, downloadJsonFile, loadOverlay, markBackupNudgeDismissed, markKitchenBackupExported, shouldShowBackupNudge } from '../../backup.js?v=236';
import { dismissPwaInstallPrompt, getPwaInstallPromptState, promptPwaInstall } from '../../pwa-install.js?v=236';
