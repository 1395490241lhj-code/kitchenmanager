...
import { getCanonicalName, guessKitchenUnit, UNIT_TYPE } from '../../ingredients.js?v=238';
import { applyCookCalibration, computeCookDeductions, gearInfo, GEAR_LABELS, isInventoryAvailable } from '../../inventory.js?v=238';
import { markRecipeCookedKeepPlan } from '../../recommendations.js?v=238';
import { callAiForCookedMeal, formatAiErrorMessage, withTimeout } from '../../ai.js?v=238';
import { escapeHtml, escapeOptionAttr, showToast } from '../../components/status.js?v=238';
...
} from '../../utils/cooked-meal.js?v=238';
import { isDemoKitchenMode, refreshDemoKitchenBanner, setDemoStep } from './demo-kitchen.js?v=238';
import { getTodayPendingPlanRows, isPendingPlanRow } from '../../plan-selectors.js?v=238';
