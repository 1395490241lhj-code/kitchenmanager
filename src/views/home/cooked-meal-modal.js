...
import { getCanonicalName, guessKitchenUnit, UNIT_TYPE } from '../../ingredients.js?v=236';
import { applyCookCalibration, computeCookDeductions, gearInfo, GEAR_LABELS, isInventoryAvailable } from '../../inventory.js?v=236';
import { markRecipeCookedKeepPlan } from '../../recommendations.js?v=236';
import { callAiForCookedMeal, formatAiErrorMessage, withTimeout } from '../../ai.js?v=236';
import { escapeHtml, escapeOptionAttr, showToast } from '../../components/status.js?v=236';
...
} from '../../utils/cooked-meal.js?v=236';
import { isDemoKitchenMode, refreshDemoKitchenBanner, setDemoStep } from './demo-kitchen.js?v=236';
import { getTodayPendingPlanRows, isPendingPlanRow } from '../../plan-selectors.js?v=236';
