...
import { getCanonicalName, guessKitchenUnit, UNIT_TYPE } from '../../ingredients.js?v=237';
import { applyCookCalibration, computeCookDeductions, gearInfo, GEAR_LABELS, isInventoryAvailable } from '../../inventory.js?v=237';
import { markRecipeCookedKeepPlan } from '../../recommendations.js?v=237';
import { callAiForCookedMeal, formatAiErrorMessage, withTimeout } from '../../ai.js?v=237';
import { escapeHtml, escapeOptionAttr, showToast } from '../../components/status.js?v=237';
import { getCookShoppingCandidates, showCookCompleteFeedback } from '../../components/cook-feedback.js?v=237';
import {
...
} from '../../utils/cooked-meal.js?v=237';
import { isDemoKitchenMode, refreshDemoKitchenBanner, setDemoStep } from './demo-kitchen.js?v=237';
import { getTodayPendingPlanRows, isPendingPlanRow } from '../../plan-selectors.js?v=237';
